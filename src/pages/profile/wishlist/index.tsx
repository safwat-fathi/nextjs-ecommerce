...
const Wishlist: NextPage<PageProps> = ({ data }) => {
  ...
  return (
    <>
      ...
      <Section>
        <h4 className="text-lg font-medium capitalize mb-4">My Wishlist</h4>
...
export default renderWithLayout(Wishlist, LayoutsENUM.PROFILE);
