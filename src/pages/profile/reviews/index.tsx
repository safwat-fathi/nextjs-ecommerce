...
const Reviews: NextPage<PageProps> = ({ data }) => {
  ...
  return (
    <>
      ...
      <Section>
        <h4 className="text-lg font-medium capitalize mb-4">My Reviews</h4>
...
export default renderWithLayout(Reviews, LayoutsENUM.PROFILE);
