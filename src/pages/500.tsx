...
export const getStaticProps: GetStaticProps<any> = async ctx => {
  ...
  return {
    props: {
      ...(await serverSideTranslations(ctx.locale!, ["common", "500"])),
      // error: null,
    },
  };
};

const ServerErrorPage: NextPage<any> = () => {
  const { t } = useTranslation(["500", "common"]);

  const router = useRouter();

  // const errorMessage = router.query.error;
  // console.log("🚀 ~ ServerErrorPage ~ errorMessage:", errorMessage);
